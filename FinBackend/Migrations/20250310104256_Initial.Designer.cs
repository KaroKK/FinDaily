...
namespace FinBackend.Migrations
{
    ...
    [Migration("20250310104256_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinBackend.Models.ActionLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FinBackend.Models.Categ", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FinBackend.Models.PayWay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FinBackend.Models.PlanBud", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FinBackend.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FinBackend.Models.ActionLog", b =>
                {
                    b.HasOne("FinBackend.Models.User", "TheUser")
                        .WithMany()
            ...
            modelBuilder.Entity("FinBackend.Models.CashFlow", b =>
                {
                    b.HasOne("FinBackend.Models.Categ", "TheCat")
                        .WithMany()
                        .HasForeignKey("CatId");

                    b.HasOne("FinBackend.Models.PayWay", "ThePay")
                        .WithMany()
                        .HasForeignKey("PayId");
